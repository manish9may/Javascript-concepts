...
app.use(session({
    secret: 'ExtJS-javascript-practice-target',
...
app.listen(8085, function () {
    console.log("'Ext JS 5.1.1 Practice Target' Express server listening on port %d in %s mode", this.address().port, app.settings.env);
});