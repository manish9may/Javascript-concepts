...
var express = require('../../node_modules/express'),
    ...
    app = express();
app.use(session({
    secret: 'javascript-concept-practice',
...
app.listen(8085, function () {
    console.log("'Javascript Concept Practice' Express server listening on port %d in %s mode", this.address().port, app.settings.env);
});
