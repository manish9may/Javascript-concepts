...
app.use(session({
    secret: 'angular2-javascript-practice-target',
...
app.listen(8085, function () {
    console.log("'Angular2 JS Practice Target' Express server listening on port %d in %s mode", this.address().port, app.settings.env);
});
